...
#' 
#' Tidy data lets you focus on analyzing the data rather than getting the data 
#' in the right format for different functions/packages.
#' 
#' Good analysis usually iterates between all the various stages but...
#' going back and forth between modeling/visualization/transformation 
#' is absolutely vital!
#' 
...
#' Need to install several packages and what not in order for the code 
#' in the book to run smoothly on my local machine. 
#'  
...
#' Didn't know about this one, you can use `tidyverse_update()` to check for 
#' updates to packages within the tidyverse and choose which to install.
#' 
